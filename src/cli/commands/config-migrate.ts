...
# See SPEC §11.H for the schema and .warren/MIGRATION.md for hand-edited
# examples.
`;

const PREVIEW_HEADER = `# .warren/preview.yaml — per-run preview environment (warren-5840, SPEC §11.L).
#
